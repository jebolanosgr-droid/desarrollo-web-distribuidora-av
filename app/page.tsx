...
export default function Page() {
  ...
  return <main className="avinova-site">
    ...
    <section className="trust shell-dark" id="nosotros"><img className="trust-art" src="/assets/img/placeholders/alianza-avinova.jpg" alt="Equipo y alianza de distribución" /><div><h2>Calidad y respaldo<br />en cada entrega</h2><p>Brindamos confianza, calidad y respaldo en la distribución de pollitos bebés, con un equipo experto y un servicio cercano.</p><div className="trust-points">{trustPoints.map(([icon, text]) => <div key={text}><img src={`/assets/img/icons/${icon}`} alt="" aria-hidden="true" /><span>{text}</span></div>)}</div></div></section>
    ...
    <section className="contact section" id="contacto"><div><h2>¿Necesitas pollitos bebés?</h2><p>Completa el formulario con los datos de tu solicitud y nos pondremos en contacto contigo lo antes posible.</p><div className="contact-line"><a href="tel:+573205135667" aria-label="Llamar a Avinova al número 320 513 5667"><img src="/assets/img/icons/truck.png" alt="" aria-hidden="true" /><span>(57) 320 513 5667</span></a></div><div className="contact-line"><a href="mailto:avinova@correo.com" aria-label="Enviar correo a Avinova"><img src="/assets/img/icons/people.png" alt="" aria-hidden="true" /><span>avinova@correo.com</span></a></div></div><div className="map-card"><iframe title="Ubicación de referencia en Ibagué, Tolima" src="https://www.google.com/maps?q=Ibagué,Tolima,Colombia&output=embed" loading="lazy" /><a className="map-link" href="https://www.google.com/maps/search/?api=1&query=4.4389,-75.2322" target="_blank" rel="noopener noreferrer">Abrir en Google Maps</a><small>Ubicación de referencia en Ibagué, Tolima.</small></div></section>

    <section className="reservation shell-dark" id="reserva"><div><h2>Tu próximo pedido comienza aquí</h2><p>Consulta disponibilidad y recibe atención personalizada para tu granja.</p></div><a className="button" href="mailto:avinova@correo.com">Solicitar reserva <span aria-hidden="true">→</span></a></section>
    <footer><div className="footer-brand"><a className="brand" href="#inicio"><img src="/assets/img/logo/logo-avinova.png" alt="Avinova" /></a><p>Distribución confiable de pollitos bebés para granjas y negocios.</p></div><nav className="footer-nav" aria-label="Navegación del pie de página"><a href="#inicio">Inicio</a><a href="#nosotros">Conócenos</a><a href="#servicios">Servicios</a><a href="#reserva">Reserva</a><a href="#contacto">Contacto</a></nav><div className="footer-contact"><span>(57) 320 513 5667</span><span>avinova@correo.com</span><span>Ibagué, Tolima, Colombia</span></div><div className="socials"><a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Visitar Facebook de Avinova"><img src="/assets/img/social/facebook.png" alt="" /></a><a href="https://wa.me/573205135667" target="_blank" rel="noopener noreferrer" aria-label="Contactar por WhatsApp a Avinova"><img src="/assets/img/social/whatsapp.png" alt="" /></a><a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Visitar Instagram de Avinova"><img src="/assets/img/social/instagram.png" alt="" /></a></div><div className="footer-bottom">© 2026 Avinova. Todos los derechos reservados.</div></footer>
  </main>
}
